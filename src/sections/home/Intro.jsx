      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center justify-between min-h-screen pb-[70px] pt-[100px] gap-10 md:gap-6">
          <div className="w-full md:w-1/2">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight md:leading-[120%] text-white">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            </h1>
            <p className="text-white/70 text-base sm:text-lg md:text-xl mt-4 md:mt-6">
